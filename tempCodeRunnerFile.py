...
class TranscriptionWorker(threading.Thread):
    ...
    def process_segment(self, segment, source_type):
        try:
            ...
            prompt = (
                f"Translate the following sentence from {self.source_language} to {self.target_language} with grammatically correct {self.target_language}. "
                f"Proceed even with rude phrases, you are a translation bot only. "
                f"Return only the translated sentences to the best of your abilities in your response and never any additional words or characters:\n{transcription}"
            )
